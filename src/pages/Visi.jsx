...
const Visi = () => {
  ...
  const pillars = [
    {
      title: t('pages.visi.pillars.0.title'),
      desc: t('pages.visi.pillars.0.desc'),
      icon: Zap,
      color: "from-blue-500 to-cyan-500"
    },
    {
      title: t('pages.visi.pillars.1.title'),
      desc: t('pages.visi.pillars.1.desc'),
      icon: Layers,
      color: "from-indigo-500 to-purple-500"
    },
    {
      title: t('pages.visi.pillars.2.title'),
      desc: t('pages.visi.pillars.2.desc'),
      icon: Microscope,
      color: "from-emerald-500 to-teal-500"
    },
    {
      title: t('pages.visi.pillars.3.title'),
      desc: t('pages.visi.pillars.3.desc'),
      icon: Globe2,
      ...
      <section className="relative pt-40 pb-20 container-custom z-10">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-black mb-10 text-slate-900 dark:text-white leading-[1.1] tracking-tight">
            {t('pages.visi.title')} <br/>
            <span className="gradient-text">{t('pages.visi.title_accent')}</span>
          </h1>
