    ...
    <div className="min-h-screen pt-32 pb-20 bg-white dark:bg-slate-950 overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="max-w-4xl mb-24">
          ...
          >
            {t('curriculum.title')} <span className="gradient-text">{t('curriculum.title_accent')}</span>
          </m.h1>
          <m.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-32">
          ...
          >
            ...
            <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-6">{t('curriculum.digital_era.title')}</h3>
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              {t('curriculum.digital_era.desc')}
            </p>
          </m.div>
          ...
          >
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-black mb-6">{t('curriculum.holistic_vision.title')}</h3>
              <p className="text-slate-300 leading-relaxed">
                {t('curriculum.holistic_vision.desc')}
              </p>
            </div>
        ...
        <div className="bg-gradient-to-br from-indigo-600 to-primary-700 rounded-[4rem] p-12 md:p-20 text-white mb-32 relative overflow-hidden shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
            <div>
              <h2 className="text-3xl md:text-5xl font-black mb-8 leading-tight">{t('curriculum.obe.title')}</h2>
              <p className="text-indigo-100 text-lg mb-8 leading-relaxed">
                {t('curriculum.obe.desc')}
              </p>
              <div className="space-y-4">
                {(t('curriculum.obe.points', { returnObjects: true }) || []).map((item, i) => (
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { label: t('curriculum.obe.roles.educator'), icon: Users },
                { label: t('curriculum.obe.roles.researcher'), icon: Search },
                { label: t('curriculum.obe.roles.developer'), icon: Cpu },
                { label: t('curriculum.obe.roles.entrepreneur'), icon: Zap },
              ].map((prof, i) => (
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {(t('curriculum.tags', { returnObjects: true }) || []).map((tag, i) => (
